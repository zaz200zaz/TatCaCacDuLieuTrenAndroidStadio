...
public class renRakuchoAdapter extends RecyclerView.Adapter<renRakuchoAdapter.UserHolder>  {
    ...
    public renRakuchoAdapter(ArrayList<User> users, Context context, OnUserClickListener onUserClickListener,String myUsername) {
        this.users = users;
...
//        s+=acount;
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( @NonNull DataSnapshot dataSnapshot) {
                ...
                if (message.size()<=0){
                    holder.txtTime.setText("");holder.txtTime.setVisibility(View.GONE);
                    holder.txtMessage.setText("");holder.txtMessage.setVisibility(View.GONE);
                }else{
