...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserHolder>{
        ...
        private ArrayList<com.example.ankiapp.User> users;
        private Context context;
        private OnUserClickListener onUserClickListener;

        public UsersAdapter(ArrayList<com.example.ankiapp.User> users, Context context, OnUserClickListener onUserClickListener) {
            this.users = users;
